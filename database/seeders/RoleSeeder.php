...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.authors.index', 'description' => 'Ver listado de autores'])->syncRoles([$admin,$admin_tienda, $editor]);
        Permission::create(['name' => 'admin.authors.create', 'description' => 'Crear Autor'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.authors.edit', 'description' => 'Editar Autor'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.authors.destroy', 'description' => 'Eliminar Autor'])->syncRoles([$admin]);

        //categorias
        Permission::create(['name' => 'admin.categories.index', 'description' => 'Ver Listado de Categorias'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.categories.create', 'description' => 'Crear Categorias'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.categories.edit', 'description' => 'Editar Categorias'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.categories.destroy', 'description' => 'Eliminar Categorias'])->syncRoles([$admin]);

        //repositorios
        Permission::create(['name' => 'admin.repositories.index', 'description' => 'Ver Listado de Repositorios'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.repositories.create', 'description' => 'Crear Repositorio'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.repositories.edit', 'description' => 'Editar Repositorio'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.repositories.destroy', 'description' => 'Eliminar Repositorio'])->syncRoles([$admin]);

        //Productos
        Permission::create(['name' => 'admin.products.index', 'description' => 'Ver Listado de Productos'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.products.create', 'description' => 'Crear Producto'])->syncRoles([$admin,$admin_tienda,$editor]);
        Permission::create(['name' => 'admin.products.edit', 'description' => 'Editar Producto'])->syncRoles([$admin,$admin_tienda,$editor]);
        ...
        // Permission::create(['name' => 'nav.admin_tienda'])->assignRole('admin_tienda');
