    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA15.png')}}">
          </div>
...
de Bolivia</h1>
                ...
                <p class="leading-relaxed">
                    En esta su decima quinta entrega, Piedra de agua presenta un dossier referido a la publicación realizada por el Banco Central de Bolivia, recientemente editada en dos tomos: Historia monetaria de Bolivia. De sus páginas extractamos fragmentos de tres destacados investigadores que abordan temas cruciales en el desarrollo de ese devenir histórico: Carmen Beatriz Loza,
Clara López Beltrán y Gustavo Rodríguez Ostria.
                  </p>
