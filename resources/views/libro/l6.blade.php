    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA6.png')}}">
          </div>
          ...
          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                ...
                <p class="leading-relaxed">
                    Con motivo de la publicación de las Obras Completas de
                Gunnar Mendoza, realizada por la Fundación Cultural
del Banco Central de Bolivia y el Archivo y Bibliotecas
Nacionales de Bolivia en Sucre en el año 2005, a manera de estudio introductorio, el historiador y escritor
norteamericano William Lofstrom, escribió un extenso
“Ensayo Biográfico” del cual transcribimos aquí varios
párrafos referidos a algunos de los momentos más importantes de la vida de don Gunnar Mendoza Loza.
