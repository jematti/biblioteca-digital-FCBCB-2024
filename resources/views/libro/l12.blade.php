    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA12.png')}}">
          </div>

          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                    Dossier Nuevos desafíos de la
                    Fundación Cultural BCB
                    </h1>
                <h2 class="text-lg title-font text-gray-500 tracking-widest">Revista Nacional Piedra de Agua</h2>

                <p class="leading-relaxed">
                    La presente entrega de Piedra de agua correspondiente
                    a los meses de julio y agosto, propone, en su dossier
                    dedicado a los nuevos desafíos que debe encarar la
                    Fundación Cultural del Banco Central de Bolivia (FCBCB), un acercamiento a su concepción, estructura y dinámica operativa, para un mejor conocimiento de su accionar en beneficio de la sociedad boliviana
                </p>
