    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA8.png')}}">
          </div>

          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                    Dossier Enfoque cerámico
                ...
                <p class="leading-relaxed">
                    La Reunión Anual de Etnología (RAE - 2014), es la ocasión para detenernos en la colección de cerámica del Museo Nacional de Etnografía y Folklore (MUSEF), según la
                    cadena de producción. Un nuevo y muy acertado enfoque
                    planteado desde la anterior versión, cuando esta estuvo dedicada al textil. Ahora es el turno de la cerámica, la cual fue
                    minuciosamente analizada con la participación de especialistas nacionales y extranjeros durante los días del evento
                    realizado en La Paz del 18 al 22 de agosto.
                </p>
