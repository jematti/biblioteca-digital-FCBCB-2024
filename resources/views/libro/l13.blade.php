    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA13.png')}}">
          </div>
          ...
          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                ...
                <p class="leading-relaxed">
                    La vigésima novena Reunión Anual de Etnografía
                    RAE, desarrollada recientemente en las ciudades de
                    La Paz y Sucre, estuvo dedicada al Arte plumario,
                    una manifestación cultural de mucha presencia en Bolivia,
                    tanto en las tierras altas como en las bajas. El dossier de
                    este décimo tercer número de Piedra de agua se ocupa de
                    ello, abordando algunos aspectos de ese rico y colorido
                    orbe cultural. Un acercamiento a la colección de arte plumario del Museo Nacional de Etnografía y Folklore según
