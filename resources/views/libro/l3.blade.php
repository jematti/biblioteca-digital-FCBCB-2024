    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA3.png')}}">
          </div>

          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                    Dossier Bienal Internacional de Arte SIART</h1>
                <h2 class="text-lg title-font text-gray-500 tracking-widest">Revista Nacional Piedra de Agua</h2>

                <p class="leading-relaxed">
                    En base a tres ejes conceptuales, presentó las
                    exposiciones de Territorios inestables; una plataforma
                    de diálogo y capacitación: Pensamientos abiertos, e Integrando
                    Artes, un diálogo entre diversas
                    disciplinas artísticas. La curaduría estuvo a cargo de José
                    Bedoya y Sandra De Berduccy
                </p>
