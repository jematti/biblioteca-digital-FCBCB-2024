    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA10.png')}}">
          </div>

          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                    Dossier  Música Comtemporánea en Bolivia</h1>
                <h2 class="text-lg title-font text-gray-500 tracking-widest">Revista Nacional Piedra de Agua</h2>

                <p class="leading-relaxed">
                    Esta décima entrega de Piedra de agua, dedica su dossier
                    a la llamada música contemporánea y su práctica en
                    Bolivia. Una práctica que implica una doble lectura.
                    Por un lado, la pulsión transgresora propia de quien cuestiona y propone y, por otra, la relación con una tradición
                    musical ancestral y poderosa. Un diálogo en suma, entre esas
                    dos dimensiones en una suerte de tensión complementaria.
                    Por ello precisamente, dialogamos con algunos de sus más
                    destacados cultores en busca de sus claves y profundas motivaciones
                  </p>
