    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA18.png')}}">
          </div>

          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                    Dossier:
XXX Reunión Anual de Etnología</h1>
                <h2 class="text-lg title-font text-gray-500 tracking-widest">Revista Nacional Piedra de Agua</h2>

                <p class="leading-relaxed">
                    Un poco de historia
El Museo Nacional de Etnografía y Folklore
(MUSEF) del Estado Plurinacional de Bolivia
tiene sus inicios en el primer centenario de la entonces
República Nacional de Bolivia. En 1925, bajo la presidencia de Bautista Saavedra se creó el Departamento Científico de Etnografía como una repartición del
Museo Nacional de Bolivia
                  </p>
