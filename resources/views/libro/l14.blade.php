    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA14.png')}}">
          </div>
          ...
          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                ...
                <p class="leading-relaxed">
                    El legado cultural del Pueblo Afroboliviano fue motivo de una actividad muy significativa en la Casa
                    de la Libertad de Sucre. Allí, miembros de todas las
                    edades de este pueblo –oficialmente reconocido dentro de
                    la diversidad cultural de nuestro país– se apropiaron de
                    los espacios para mostrar su historia, música, religiosidad,
                    arte, gastronomía y otros aspectos de su rico legado cultural. De esa enriquecedora experiencia se ocupa el presente
                    dossier de Piedra de agua, a través de textos que dan cuenta de varios aspectos de lo Afroboliviano para un mejor
                    conocimiento de ese pueblo, en una dinámica intercultural
                    de conocimiento mutuo que aliente el diálogo propositivo
                    hacia una convivialidad enriquecida.
                  </p>
