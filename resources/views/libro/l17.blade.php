    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA17.png')}}">
          </div>

          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                    50 años del Museo Nacional de Arte</h1>
                <h2 class="text-lg title-font text-gray-500 tracking-widest">Revista Nacional Piedra de Agua</h2>

                <p class="leading-relaxed">
                    El dossier del presente número de Piedra de agua, está dedicado al Museo Nacional de Arte, con motivo de sus 50 años de vida. Importantes trabajos, como la restauración de su edificio y una nueva museografía, se han realizado para conmemorar esta fecha, prueba de la vigencia
de una institución que brinda un importante servicio de preservación y
valoración de nuestro patrimonio –parte fundamental de nuestra identidad como bolivianos–, adecuando su funcionamiento a las necesidades
y expectativas de nuestra sociedad actual.
                  </p>
