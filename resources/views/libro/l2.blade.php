    ...
    <div class="container px-5 mx-auto bg-white">
        ...
        <div class="md:flex md:justify-center md:gap md:items-center">
          ...
          <div class="md:w-3/12  p-5">
                <img alt="ecommerce" src="{{ asset('img/PA2.png')}}">
          </div>

          <div class="md:w-9/12 p-6 rounded-lg shadow-xl">
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">
                    Dossier Encuentro Visión siglo XXI MUSEOS</h1>
                <h2 class="text-lg title-font text-gray-500 tracking-widest">Revista Nacional Piedra de Agua</h2>

                <p class="leading-relaxed">
                    Los museos han dejado de ser exquisitas colecciones
                    donde se exhiben obras auráticas que, no en pocos casos, han formado los gustos, las escalas valorativas e
                    incluso la instauración de cánones estéticos y paradigmas culturales, para integrarse ahora a un debate abierto a la sociedad,
                    donde los saberes fluyen en ambas direcciones, de modo que
                    la institución museística escucha y atiende las demandas de la
