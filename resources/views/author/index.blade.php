...
<div class="max-w-7xl">
    ...
    <!-- Tabla de datos de los autores de libros -->
            ...
            <table class="table table-compact w-full">
                <thead class="text-sm font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                        <th></th>
                        <th class="p-2">
                            <div class="font-semibold text-left max-w-xl">Nombre</div>
                        </th>
                        <th class="p-2">
                ...
                <tbody class="text-sm divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-100">
                        <td class="p-2">
                            <div class="font-semibold text-base text-center">{{ $authors->id }}</div>
                        </td>
                        <td class="p-2">
                            <div class="font-medium text-base text-left text-gray-800">
