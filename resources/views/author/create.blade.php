...
<div class="max-w-5xl">
    ...
    <form action="{{ route('author.store') }}" method="POST" novalidate>
        ...
        <div class="mb-5">
            ...
            <input type="submit" value="Añadir Autor" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full text-white rounded-lg p-3 mt-5" />
    </form>
