...
<div class="max-w-2xl">
    <h2 class="bg-custom-100 text-white uppercase text-lg rounded-lg p-4 text-center font-bold ">Lista de Categorías</h2>
    ...
    <!-- Tabla de datos de categorias de libros -->
    <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
        <header class="px-5 py-4 border-b border-gray-100">
            <div class="font-semibold text-gray-800">Categorías</div>
        </header>
            ...
            <table class="table-auto w-full">
                <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                        <th>ID</th>
                        <th class="p-2">
                            <div class="font-semibold text-left">Nombre Categoría</div>
                        </th>
                        <th class="p-2">
