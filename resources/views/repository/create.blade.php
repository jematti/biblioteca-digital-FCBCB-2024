...
<h2 class="bg-custom-100 text-white uppercase text-lg rounded-lg p-4 text-center font-bold ">Repositorio</h2>
        ...
        <div class="mt-5">
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                <div class="w-full px-3">
                    ...
                    <input id="ubicacion" type="text" name="ubicacion" placeholder="Dirección Actual" class="border p-3 w-full rounded-lg" value="{{old('ubicacion')}}" />
                </div>
            </div>
        </div>

        <div class="mt-5">
            {{-- sigla - ciudad del repositorio --}}
            <div class="flex flex-wrap -mx-3 mb-3">
            ...
            <input type="submit" value="Añadir Repositorio" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full text-white rounded-lg p-3 mt-5" />
        </div>
</form>
@endsection
