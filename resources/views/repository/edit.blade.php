...
@section('contenido-admin')
    ...
    <h2 class="bg-white text-lg rounded-lg p-4 text-center font-bold border-2 border-sky-800">Editar Repositorio</h2>

      {{-- formulario para agregar repositorio --}}
      <form action="{{ route('repository.update',['repository'=>$repository->id]) }}" method="POST" novalidate>
                ...
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        @error('nombre_repositorio')
                            border-red-500
                        @enderror
                        value="{{$repository->nombre_repositorio}}"
                    />
                    @error('nombre_repositorio')
                ...
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        @error('nombre_encargado')
                            border-red-500
                        @enderror
                        value="{{$repository->nombre_encargado}}"
                    />
                    @error('nombre_encargado')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2">{{$message}}</p>
                    @enderror
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        type="text"
                        name="ubicacion"
                        placeholder="Insertar desde el Mapa de Google Maps"
                        class="border p-3 w-full rounded-lg"
                        value="{{$repository->ubicacion}}"
                    />
                </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-3">
                ...
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        @error('horario_atencion')
                            border-red-500
                        @enderror
                        value="{{$repository->horario_atencion}}"
                    />
                    @error('horario_atencion')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2">{{$message}}</p>
                    @enderror
