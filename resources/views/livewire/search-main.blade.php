            ...
            <div class="px-4 py-3">
                ...
                <a href="{{ route('products.show', $product) }}" class="flex">
                    ...
                    <div class="ml-4 ">
                        ...
                        <p class="text-sm  text-gray-500 font-medium">{{ $product->author->nombre_autor}}</p>
                    </div>
                </a>
                <hr>
                @empty
