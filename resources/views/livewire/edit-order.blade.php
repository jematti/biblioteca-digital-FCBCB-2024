        ...
        <div class="shadow-lg bg-white text-lg  p-2 rounded-lg" x-data="{tipo_pago: @entangle('tipo_pago')}">
            ...
            <div>
                <label class="px-3 py-2 flex items-center">
                    <input x-model="tipo_pago" { old('tipo_pago.10')="10" ? 'checked=' .'"'.'checked'.'"' : '' } type="radio" value="10" name="tipo_pago[10]" class="text-gray-600">
                    @error('tipo_pago')
                    <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2">{{$message}}</p>
                    @enderror
            ...
            <div class="p-2 mt-2 hidden" :class="{'hidden': tipo_pago != 10 }">
            ...
            <div>
                <label class="px-3 py-2 flex items-center">
                    <input x-model="tipo_pago" { old('tipo_pago.20')="20" ? 'checked=' .'"'.'checked'.'"' : '' } type="radio" value="20" name="tipo_pago[20]" class="text-gray-600">
                    <span class="ml-2 text-gray-700">
            ...
            <div class="px-6 pb-6 mt-2 hidden " :class="{'hidden': tipo_pago != 20 }">
                <div class="flex items-center ml-3">
                    <p class="font-semibold text-base">
                        <i class="fa-solid fa-chevron-right"></i>
                        Info. Deposito
            ...
            <hr>
            <p class="text-red-500 text-center font-semibold italic text-sm"><i class="fa-solid fa-circle-info"></i>¡Subir un nuevo comprobante de pago, solo si es necesario!</p>
            {{-- subir comprobante de pago --}}
            <div class="mb-2">
                <label class="text-base " for="imagen_factura">
                    <div class="flex my-2">
                        <p class="font-bold text-lg text-black pl-2">Subir Nuevo Comprobante de Pago</p>
                ...
                <div class="flex flex-col ">
                    ...
                    <a class=" bg-sky-500 hover:bg-sky-700 text-center text-white font-bold py-2 px-4 my-2 rounded-lg" href="{{ asset('depositos').'/'.$imagen_deposito}}" target="_blank" rel="noopener noreferrer">
                        Ver Imagen de deposito "Actual"
                    </a>
