        ...
        <ul class="divide-y">
            ...
            <li>
                <div class="flex">
                    ...
                    <div>
                        {{-- boton enlace para corregir la orden de compra--}}
                        @if ($order->estado == 1)
                        <button onclick="location.href = '{{ route('orderscreate.edit',$order->id) }}'" class="mt-2 ml-5 px-5 bg-red-500 hover:bg-red-400 text-white font-bold py-2 rounded-lg ">
