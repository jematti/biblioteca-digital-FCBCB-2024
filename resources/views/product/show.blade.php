        ...
        <div class="container px-5 py-5 mx-auto">
            <div class="lg:w-full flex flex-wrap mx-2 object-center">
                ...
                <div class="lg:w-2/5 w-full lg:pl-5 lg:py-6 lg:pr-2 mt-6 lg:mt-0 ">
                    <h1 class="text-gray-900 text-xl title-font font-medium mb-1">{{ $product->titulo }}</h1>
                    <h2 class="text-lg title-font text-gray-500 tracking-widest">
                        <a class="no-underline hover:underline" href="{{ route('author.show', $product->author->id) }}">
                    ...
                    <div class="flex">
                        ...
                        <button class="flex text-white bg-green-700 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">{{ $product->category->nombre_categoria }}</button>
                    </div>
                </div>
                ...
                <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div class="flex items-start justify-between p-2 border-b border-solid border-slate-200 rounded-t">
                        <h3 class="text-xl font-semibold">
                            Contactanos en la Ciudad de {{ $product->repository->ciudad}}
                        </h3>
                    ...
                    <div class="flex flex-col p-2">
                        <div class="flex flex-row">
                            ...
                            <p class="font-medium text-black text-base leading-relaxed mx-1 ">
                                Correo Electronico: {{ $product->repository->correo}}
                        ...
                        <div class="flex flex-row">
                            ...
                            <p class="font-medium text-black text-base leading-relaxed mx-1 ">
                                Celulares/Telefonos: {{ $product->repository->telefono}}
                            </p>
                        </div>
                        <div class="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <p class="font-medium text-black text-base leading-relaxed mx-1 ">
                                Encargado: {{ $product->repository->nombre_encargado}}
                            </p>
                        </div>
                        <div class="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
