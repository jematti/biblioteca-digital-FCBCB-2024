        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/5 p-6 flex flex-col">
                <a href="#">
                    ...
                    <button  onclick="location.href = '/libro'" class="flex items-center justify-center w-full px-2 py-2 mt-4 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-sky-800 rounded-md hover:bg-green-700 focus:outline-none focus:bg-green-700">
            ...
            <div class="w-full md:w-1/3 xl:w-1/5 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('img/l9.jpg')}}">
                    <div class="pt-3  items-center justify-between">
                        <p class="mt-2 text-xl font-medium text-dark ">Libro </p>
                        <p class="">Autor</p>
                        <svg class="h-6 w-6 fill-current text-gray-500 hover:text-black"  viewBox="0 0 24 24">
            ...
            <div class="w-full md:w-1/3 xl:w-1/5 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('img/l10.jpg')}}">
                    <div class="pt-3  items-center justify-between">
                        <p class="mt-2 text-xl font-medium text-dark ">Libro </p>
                        <p class="">Autor</p>
                        <svg class="h-6 w-6 fill-current text-gray-500 hover:text-black"  viewBox="0 0 24 24">
